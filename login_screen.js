...
function checkValid(){
    ...
    let passWordError = document.querySelector(`#${passWord.parentElement.id} .error`);
    ...
    if(eMail.value == ''){
        ...
        eMailError.previousElementSibling.style.backgroundColor = "rgba(255, 150, 150, 1)";
    ...
    if(passWord.value == ''){
        ...
        passWordError.previousElementSibling.style.backgroundColor = "rgba(255, 150, 150, 1)";
        ...
        passWordError.previousElementSibling.style.backgroundColor = "rgba(255, 255, 150, 1)";
