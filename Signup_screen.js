...
function checkIfValid(){
  ...
  let unmachingPasswordField1 = document.querySelector(`#${fields[5].parentElement.id} .error`) ;
  let unmachingPasswordField2 = document.querySelector(`#${fields[6].parentElement.id} .error`) ;

  unmachingPasswordField1.textContent = "Passwords do not match !";
  unmachingPasswordField1.previousElementSibling.style.backgroundColor = "rgba(255, 255, 150, 1)";
  ...
  unmachingPasswordField2.previousElementSibling.style.backgroundColor = "rgba(255, 255, 150, 1)";
  ...
  if(fieldState[5] != 0){
    if(fields[5].value.length < 8){
      let shortPasswordField = document.querySelector(`#${fields[5].parentElement.id} .error`) ;
      shortPasswordField.previousElementSibling.style.backgroundColor = "rgba(255, 255, 150, 1)";
  ...
  if(fieldState[6] != 0){
    if(fields[6].value.length < 8){
      let shortPasswordField = document.querySelector(`#${fields[6].parentElement.id} .error`) ;
      shortPasswordField.previousElementSibling.style.backgroundColor = "rgba(255, 255, 150, 1)";
      shortPasswordField.textContent = "Password must be atleast 8 characters"
      shortPasswordField.style.color = "rgba(255, 255, 150, 1)";
      shortPasswordField.style.fontSize = "15px";
